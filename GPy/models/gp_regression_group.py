...
class GPRegressionGroup(GP):
    ...
    :param G: group matrix (g * n), specifying each point belonging to which group
    ...
    def __init__(self, X, Y, G, kernel=None, Y_metadata=None, normalizer=None, noise_var=1., mean_function=None):
